...
class CoffeMachineTest(unittest.TestCase):
    ...
    def test_insert_chocolate(self):
        machine = CoffeeMachine()
        machine.insert_chocolate(1000)
        self.assertEqual(machine.chocolate, 1000)
    
    
    def test_insert_capuchino(self):
        machine = CoffeeMachine()
        machine.insert_coffee(500)
        machine.insert_chocolate(500)
    ...
    def test_get_capuchino_ok(self):
        ...
        coffee_result = machine.get_coffee()
        self.assertTrue(coffee_result)
        self.assertEqual(machine.coffee, 500-30)
        self.assertEqual(machine.chocolate, 500-30)
        self.assertEqual(machine.sugar, 1000-5)
        self.assertEqual(machine.coins, 1)

    ''' def test_get_te_ok(self):
        machine = CoffeeMachine()
        machine.insert_coin()
        machine.insert_coin()
        machine.insert_te(1000)
        machine.insert_sugar(1000)
        coffee_result = machine.get_coffee()
        self.assertTrue(coffee_result)
        self.assertEqual(machine.te, 1000-10)
        self.assertEqual(machine.sugar, 1000-5)
        self.assertEqual(machine.coins, 1) '''
